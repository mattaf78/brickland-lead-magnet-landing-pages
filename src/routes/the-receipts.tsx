...
/**
 * WB004 — "The Receipts" lead-magnet landing page.
 * Ported 1:1 from WB004_LP_index.html. Styles are scoped under
 * `.receipts-root` to keep them isolated from the rest of the site.
 *
...
/**
 * Scoped CSS — every selector lives under `.receipts-root` so it cannot
 * leak into other pages. Values are 1:1 with WB004_LP_index.html.
 */
const CSS = `
.receipts-root {
