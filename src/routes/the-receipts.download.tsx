    ...
    <ReceiptsShell navLabel="Your download">
      <header className="hero-download">
        <div className="wrap">
          ...
          <p>
            One short report, six documented cases. Open it now while it's fresh — about ten minutes to skim.
          </p>
          <p style={{ marginTop: 22 }}>
            <a className="dl-btn" href={PDF_URL} download target="_blank" rel="noopener noreferrer">
              Download The Receipts (PDF) →
            </a>
          </p>
          <p className="dl-small">We've also emailed you a copy. Check your inbox (and spam, just in case).</p>
        </div>
      </header>
      ...
      <section className="band">
        <div className="wrap">
          ...
          <div className="tiny-card">
            <h2>A tiny action before you go</h2>
            <p>
          ...
          <div className="voice-card">
            <p>This is a Brickdown Alliance field report — built for you, not at you.</p>
            <p style={{ marginTop: 8 }}>
              What should we open next?{" "}
              <a href="https://thewellnessbrickdown.com/yourvoice">thewellnessbrickdown.com/yourvoice</a>
            </p>
          </div>
        </div>
      </section>
